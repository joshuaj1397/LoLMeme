...
// GetMatch grabs a MatchDto from the Riot API
func GetMatch(region string, matchID int64) (*MatchDto, error) {
	url := fmt.Sprintf("https://%s.api.riotgames.com/lol/match/v3/matches/%d", region, matchID)
	var match MatchDto
